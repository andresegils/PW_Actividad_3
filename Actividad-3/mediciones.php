            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4>Lista de Mediciones
                            <a href="addMedicion.php" class="btn btn-primary float-end">Agregar Medicion</a>
                        </h4>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              $sql_query = "SELECT * FROM mediciones";
                              ...
                              while($row = $result->fetch_assoc()){
                                ...
                                <tr>
                                    ...
                                    <td>$row[id_pozo]</td>
                                    <td>
                                      <a class='action-css' href='editMedicion.php?id=$row[id_mediciones]&id_pozo=$row[id_pozo]'>
                                        <i class='fa-solid fa-pen-to-square' style='color:#FFC107;'></i></a>
                                      <a class='action-css' href='deleteMedicion.php?id=$row[id_mediciones]'><i class='fa-solid fa-trash' style='color:red;'></i></a>
                                      <a class='action-css' href='showCharts.php?id=$row[id_mediciones]&id_pozo=$row[id_pozo]'><i class='fa-sharp fa-solid fa-chart-simple'></i></a>
                                    </td>
                                </tr>
                                ";
                              }
